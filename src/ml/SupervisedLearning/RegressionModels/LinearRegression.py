...
class LinearRegressionModel():
    ...
    def visualize(self, task_id, optimized=False):
        ...
        plt.yticks(())
        if optimized:
            plt.savefig("files/linearRegressor_" + str(task_id) + "_optimized.png", dpi=100)
            return "linearRegressor_" + str(task_id) + "_optimized.png"
        else:
            plt.savefig("files/linearRegressor_" + str(task_id) + ".png", dpi=100)
            return "linearRegressor_" + str(task_id) + ".png"
