...
class GBCModle():
    ...
    def training(self, args={"n_estimators": 100, "learning_rate": 1.0, "max_depth": 10, "random_state": 0}):
        self.__get_data()
        self.classification = GradientBoostingClassifier(**args)
    ...
    def visualize(self, task_id, optimized=False):
        ...
        if optimized:
            plt.savefig("files/gradientBoosting_" + str(task_id) + "_optimized.png", dpi=100)
            return "gradientBoosting_" + str(task_id) + "_optimized.png"
        else:
            plt.savefig("files/gradientBoosting_" + str(task_id) + ".png", dpi=100)
            return "gradientBoosting_" + str(task_id) + ".png"
    ...
    def visualize_classes(self, task_id, optimized=False):
        ...
        if optimized:
            plt.savefig("files/gradientBoosting_classes_" + str(task_id) + "_optimized.png", dpi=100)
            return "gradientBoosting_classes_" + str(task_id) + "_optimized.png"
        else:
            plt.savefig("files/gradientBoosting_classes_" + str(task_id) + ".png", dpi=100)
            return "gradientBoosting_classes_" + str(task_id) + ".png"
