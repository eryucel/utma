...
class GBRModel():
    ...
    def visualize(self, task_id, optimized=False):
        ...
        if optimized:
            plt.savefig("files/gradientBoostingRegressor_" + str(task_id) + "_optimized.png", dpi=100)
            return "gradientBoostingRegressor_" + str(task_id) + "_optimized.png"
        else:
            plt.savefig("files/gradientBoostingRegressor_" + str(task_id) + ".png", dpi=100)
            return "gradientBoostingRegressor_" + str(task_id) + ".png"
