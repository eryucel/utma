...
class LogisticRegressionModel():
    ...
    def visualize(self, task_id, optimized=False):
        ...
        if optimized:
            plt.savefig("files/logisticRegression_" + str(task_id) + "_optimized.png", dpi=100)
            return "logisticRegression_" + str(task_id) + "_optimized.png"
        else:
            plt.savefig("files/logisticRegression_" + str(task_id) + ".png", dpi=100)
            return "logisticRegression_" + str(task_id) + ".png"
    ...
    def visualize_classes(self, task_id, optimized=False):
        ...
        if optimized:
            plt.savefig("files/logisticRegression_classes_" + str(task_id) + "_optimized.png", dpi=100)
            return "logisticRegression_classes_" + str(task_id) + "_optimized.png"
        else:
            plt.savefig("files/logisticRegression_classes_" + str(task_id) + ".png", dpi=100)
            return "logisticRegression_classes_" + str(task_id) + ".png"
