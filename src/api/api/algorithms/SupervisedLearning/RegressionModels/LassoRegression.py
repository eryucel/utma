...
class LassoRegressionModel():
    ...
    def visualize(self, task_id, optimized=False):
        ...
        if optimized:
            plt.savefig("files/lassoRegressor_" + str(task_id) + "_optimized.png", dpi=100)
            return "lassoRegressor_" + str(task_id) + "_optimized.png"
        else:
            plt.savefig("files/lassoRegressor_" + str(task_id) + ".png", dpi=100)
            return "lassoRegressor_" + str(task_id) + ".png"
    ...
    def run_optimized_model(self, task_id):
        ...
        args = {"alpha": alpha, "fit_intercept": fit_intercept, "normalize": normalize, "random_state": random_state,
                "max_iter": max_iter}
