...
class SGDRegressionModel():
    ...
    def visualize(self, task_id, optimized=False):
        ...
        if optimized:
            plt.savefig("files/SGDRegressor_" + str(task_id) + "_optimized.png", dpi=100)
            return "SGDRegressor_" + str(task_id) + "_optimized.png"
        else:
            plt.savefig("files/SGDRegressor_" + str(task_id) + ".png", dpi=100)
            return "SGDRegressor_" + str(task_id) + ".png"
                    ...
                    'param':
                        {
                            'loss_group': hp.choice('loss_group',
                                                    [
                                                        ...
                                                        {
                                                            'loss': hp.choice('loss2', ['huber', 'epsilon_insensitive',
